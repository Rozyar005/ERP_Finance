...
public class Employee_Warehousing extends Employee{
    Scanner input=new Scanner(System.in);
    public Employee_Warehousing(String id, String username, String password, String role, String department) {
        super(id, username, password, role, department);
    }

    public Employee_Warehousing() {
    super();
    }
...
*/
    ...
    public void Display() {
        ...
        String query = "SELECT user_id, username, department , Amount FROM users, Budget WHERE role = 'Employee' and department='Warehouse';";
